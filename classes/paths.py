...
class Paths:
    ...
    def __init__(self, json_file_path='../JSON/outputPath.json', input_video_path=None, output_path_1=None, output_path_2=None, output_path_3=None, output_path_4=None):
        ...
        self._output_path_1 = self._validate_and_set_path(output_path_1) or self.data.get("outputpath1")
        self._output_path_2 = self._validate_and_set_path(output_path_2) or self.data.get("outputPath2")
        self._output_path_3 = self._validate_and_set_path(output_path_3) or self.data.get("outputPath3")
        self._output_path_4 = self._validate_and_set_path(output_path_4) or self.data.get("outputPath4")
    ...
    def _validate_string_path(self, value):
        ...
        if not os.path.isabs(value) and not os.path.relpath(value):
